...
import { getApproveReturnColumns, AssetReturns } from "./columns";
...
export default function Page() {
  const [data, setData] = useState<AssetReturns[]>([]);
  ...
  const fetchFilteredData = async () => {
    try {
      ...
      const response = await fetch(`${apiUrl}/manage-returns/get-filtered-returns`, {
        method: "POST",
        headers: {
